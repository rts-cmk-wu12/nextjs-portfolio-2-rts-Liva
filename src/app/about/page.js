  ...
  return (
    <>
      ...
      <main className="my-10 max-w-[70vw] mx-auto">
        ...
        <p className="text-sm text-center text-neutral-500 mt-3">Hi! I'm Amina, a web development student with a passion for creating beautiful and user-centered websites.
        ...
        <p className="text-sm text-center text-neutral-500 mt-3">For me, good web design is about storytelling.
        ...
        <p className="text-sm text-center text-neutral-500 mt-3">In my free time, I love drawing on my iPad (I use Procreate), reading graphic novels, and exploring languages and cultures through platforms like Duolingo and YouTube.
        ...
        <p className="text-sm text-center text-neutral-500 mt-3">I see web development as a space where technology meets empathy—and that's exactly where I want to be.
